...
{
//modification pour une image de fond plus grande 26-03-21
    ObjetImage *fondItem = new ObjetImage(QString(":/motif/fond2.png"));
...
{
    linformation->setText("déplacement dans une ou plusieurs directions");
